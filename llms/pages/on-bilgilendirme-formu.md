---
canonicalWebUrl: "https://www.belginkuyumculuk.com/on-bilgilendirme-formu.html"
primaryEntity: "Ön Bilgilendirme Formu"
...
> Canonical Web URL: https://www.belginkuyumculuk.com/on-bilgilendirme-formu.html
...
Ön Bilgilendirme Formu, tüketicinin sipariş vermeden önce satın alacağı ürünün temel nitelikleri, vergiler dahil toplam fiyatı, ödeme ve teslimat şekli ile finansal piyasalardaki fiyat dalgalanmalarına bağlı altın ve kıymetli madenlerde cayma hakkı istisnaları konusunda bilgilendirilmesini sağlar.
...
- `Subject`: Ön Bilgilendirme
  - `Predicate`: `mevzuat` -> `Object`: Mesafeli Sözleşmeler Yönetmeliği m.5

## 4. Karar Destek ve Sıkça Sorulan Sorular (Zero-Ambiguity FAQ)
### Soru: Belgin Kuyumculuk Ön Bilgilendirme Formu kapsamında hangi güvenceleri sağlar?
