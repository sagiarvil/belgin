...
> Primer Varlık Düğümü: https://www.belginkuyumculuk.com/rehber/altin-yatirimi-ve-ozel-matrah-rehberi/#article
...
- `Subject`: Özel Matrah
  - `Predicate`: `kanunMaddesi` -> `Object`: 3065 Sayılı Katma Değer Vergisi Kanunu Madde 23/f
- `Subject`: Altın Bedeli
  - `Predicate`: `kdvOrani` -> `Object`: %0 KDV İstisnası
- `Subject`: İşçilik Bedeli
  - `Predicate`: `kdvOrani` -> `Object`: %20 KDV Uygulaması

## 4. Karar Destek ve Sıkça Sorulan Sorular (Zero-Ambiguity FAQ)
### Soru: Belgin Kuyumculuk Altın Yatırımı & 3065 Sayılı KDV Kanunu 23/f Özel Matrah Uygulaması kapsamında hangi güvenceleri sağlar?
