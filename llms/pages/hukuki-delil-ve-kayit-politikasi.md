---
canonicalWebUrl: "https://www.belginkuyumculuk.com/hukuki-delil-ve-kayit-politikasi.html"
primaryEntity: "Hukuki Delil Politikası"
...
# Hukuki Delil ve Kayıt Politikası
> Canonical Web URL: https://www.belginkuyumculuk.com/hukuki-delil-ve-kayit-politikasi.html
...
Belgin Kuyumculuk, e-ticaret ve mesafeli sözleşme süreçlerinde HMK m. 193 uyarınca münhasır delil sözleşmesi işletir. Sipariş anında onaylanan sözleşme metinleri SHA-256 kriptografik hash fonksiyonuyla özetlenir ve OpenTimestamps protokolü aracılığıyla Bitcoin blokzincirine bağımsız dış zaman ispatı olarak işlenir.
...
- `Subject`: Hukuki Delil
  - `Predicate`: `kanitModeli` -> `Object`: SHA-256 + OpenTimestamps / Bitcoin Dış Zaman İspatı

## 4. Karar Destek ve Sıkça Sorulan Sorular (Zero-Ambiguity FAQ)
### Soru: Belgin Kuyumculuk Hukuki Delil ve Kayıt Politikası kapsamında hangi güvenceleri sağlar?
