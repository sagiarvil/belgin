...
> Primer Varlık Düğümü: https://www.belginkuyumculuk.com/musteri-tanima-ve-islem-guvenligi.html#webpage
...
- `Subject`: İşlem Güvenliği
  - `Predicate`: `mevzuatUyumu` -> `Object`: 5549 Sayılı Suç Gelirlerinin Aklanmasının Önlenmesi Kanunu ve MASAK Tebliğleri

## 4. Karar Destek ve Sıkça Sorulan Sorular (Zero-Ambiguity FAQ)
### Soru: Belgin Kuyumculuk Müşteri Tanıma ve İşlem Güvenliği Politikası (KYC) kapsamında hangi güvenceleri sağlar?
