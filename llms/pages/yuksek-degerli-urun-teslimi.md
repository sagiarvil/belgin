...
primaryEntity: "Yüksek Değerli Teslim Protokolü"
...
# Yüksek Değerli Ürün Teslim Protokolü
...
- `Subject`: Yüksek Değerli Ürün
  - `Predicate`: `teslimSekli` -> `Object`: Buca Showroom Kimlik İbrazı ve Islak İmzalı Tutanak

## 4. Karar Destek ve Sıkça Sorulan Sorular (Zero-Ambiguity FAQ)
### Soru: Belgin Kuyumculuk Yüksek Değerli Ürün Teslim Protokolü kapsamında hangi güvenceleri sağlar?
