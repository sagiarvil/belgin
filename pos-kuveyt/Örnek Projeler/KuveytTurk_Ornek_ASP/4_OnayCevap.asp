...
<body>
    ...
    <%
		...
		MerchantOrderId  = request.form("MerchantOrderId")
		Amount  = request.form("Amount")' Islem Tutari
		MD  =request.form("MD")
        ...
        HashData = b64_sha1(MerchantId&MerchantOrderId&Amount&UserName&HashedPassword)
		
	    gServer = "https://sanalpos.kuveytturk.com.tr/ServiceGateWay/Home/ThreeDModelProvisionGate"    
