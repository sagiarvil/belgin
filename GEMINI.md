# 🎛️ GEMINI MASTER SUITE & PROJE YÖNETİCİSİ ANAYASASI — BELGIN
...
## 9. FİYATLAMA VE BORSA AKIŞI SÖZLEŞMESİ (DEĞİŞMEZ KURAL — ALTIN FİYAT MOTORU MANDATE)
...
5. **LÜKS SAATLER (ELİT KATEGORİ MARJI DEVAM EDER)**: 245 Elit Lüks Saatte küresel piyasa referans fiyatı ve 2.50x katsayısı (`USD Ref × USD Kuru × 2.50`) formülü geçerlidir ve değişmez kuraldır. Komisyon/marj kaldırma kuralı yalnızca altın, sarrafiye ve mücevherat satışlarına münhasırdır.
