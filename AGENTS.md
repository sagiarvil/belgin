...
- **Fiyatlama & Borsa Akışı Kuralları (DEĞİŞMEZ KURAL — ASLA DEĞİŞTİRİLEMEZ SÖZLEŞME):**
  1. **SATIŞ FİYATLARI (HER ZAMAN +%1 KÂR MARJI - x 1.01):** Sarı Tabela (`#canli-fiyatlar`), Üst Borsa Kayan Bandı, Showroom Vitrini ve Katalogdaki tüm Altın, Ziynet, Bilezik, Külçe ve Sarrafiye ürün fiyatları yalnızca ve doğrudan `https://canlipiyasalar.haremaltin.com/` canlı borsa soket akışı (`wss://hrmsocketonly.haremaltin.com`) referans alınarak, canlı gelen ham SATIŞ fiyatları üzerine HER ZAMAN istisnasız **+%1 (x 1.01)** kâr marjı eklenerek anlık güncellenir ve yansıtılır. Bu marj sabittir, hiçbir ajan veya geliştirici tarafından kullanıcının açık onayı olmadan değiştirilemez, düşürülemez veya ezilemez.
