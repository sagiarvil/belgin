...
- **Fiyatlama & Borsa Akışı Kuralları (DEĞİŞMEZ KURAL — ALTIN FİYAT MOTORU MANDATE):**
  ...
  5. **LÜKS SAATLER (ELİT KATEGORİ CHRONO24 MARJI DEVAM EDER)**: 245 Elit Lüks Saatte Chrono24 küresel piyasa referans fiyatı ve 2.50x katsayısı (`Chrono24 USD Ref × USD Kuru × 2.50`) formülü geçerlidir ve değişmez kuraldır. Komisyon/marj kaldırma kuralı yalnızca altın, sarrafiye ve mücevherat satışlarına münhasırdır.
...
- **GİB e-Arşiv Fatura & Müşteri İzolasyonu Kuralı (DEĞİŞMEZ KURAL — ASLA DEĞİŞTİRİLEMEZ SÖZLEŞME):**
