...
- **Fiyatlama & Borsa Akışı Kuralları (DEĞİŞMEZ KURAL):**
  1. **Sarı Tabela (`#canli-fiyatlar`), Üst Borsa Kayan Bandı ve Katalog Altın & Mücevherat Ürün Fiyatları:** Yalnızca ve doğrudan `https://canlipiyasalar.haremaltin.com/` canlı borsa soket akışı (`wss://hrmsocketonly.haremaltin.com`) referans alınarak, canlı gelen SATIŞ fiyatları üzerine her zaman istisnasız **+%3 (x 1.03)** kâr marjı eklenerek anlık olarak güncellenir ve yansıtılır.
  2. **Alış / Geri Alım Fiyatları (Alış Marjı Yoktur - 0%):** Harem Altın canlı borsa soket akışındaki alış fiyatları kesinlikle hiçbir marj eklenmeden birebir (1.00 çarpan) yansıtılır.
