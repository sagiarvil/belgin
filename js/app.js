          ...
          <div class="board-exact-frame">
            ...
            <table class="board-exact-table">
              ...
              <tr>
                ...
                <td class="td-price"><span class="price-num" id="live_22k">6.441</span><span class="price-change-tag" id="change_22k">+0.00%</span></td>
              ...
              <tr>
                ...
                <td class="td-price"><span class="price-num" id="live_18k">5.152</span><span class="price-change-tag" id="change_18k">+0.00%</span></td>
              </tr>
              <tr>
                <td class="td-label">14 AYAR</td>
                <td class="td-price"><span class="price-num" id="live_14k">4.972</span><span class="price-change-tag" id="change_14k">+0.00%</span></td>
              </tr>
              <tr>
                <td class="td-label">GRAM ALTIN</td>
                <td class="td-price"><span class="price-num" id="live_gram">6.873</span><span class="price-change-tag" id="change_gram">+0.00%</span></td>
              </tr>
              <tr>
                <td class="td-label">CUMHURİYET</td>
                <td class="td-price"><span class="price-num" id="live_cumhuriyet">45.551</span><span class="price-change-tag" id="change_cumhuriyet">+0.00%</span></td>
              </tr>
              ...
              <tr>
                ...
                <td class="td-price"><span class="price-num" id="live_ceyrek_yeni">11.243</span><span class="price-change-tag" id="change_ceyrek_yeni">+0.00%</span></td>
                <td class="td-price"><span class="price-num" id="live_ceyrek_eski">11.035</span><span class="price-change-tag" id="change_ceyrek_eski">+0.00%</span></td>
              </tr>
              <tr>
                <td class="td-label">YARIM</td>
                <td class="td-price"><span class="price-num" id="live_yarim_yeni">22.462</span><span class="price-change-tag" id="change_yarim_yeni">+0.00%</span></td>
                <td class="td-price"><span class="price-num" id="live_yarim_eski">22.037</span><span class="price-change-tag" id="change_yarim_eski">+0.00%</span></td>
              </tr>
              <tr>
                <td class="td-label">ZİYNET</td>
                <td class="td-price"><span class="price-num" id="live_ziynet_yeni">44.761</span><span class="price-change-tag" id="change_ziynet_yeni">+0.00%</span></td>
                <td class="td-price"><span class="price-num" id="live_ziynet_eski">44.142</span><span class="price-change-tag" id="change_ziynet_eski">+0.00%</span></td>
              </tr>
              <tr>
                <td class="td-has-label">HAS ALTIN:</td>
                <td colspan="2" style="text-align: center; border: 2px solid #000;">
                  <span class="has-red-box"><span class="price-num" id="live_has_altin">6.873,31</span><span class="price-change-tag" id="change_has_altin">+0.00%</span></span>
                </td>
              </tr>
              </tbody>
            </table>
