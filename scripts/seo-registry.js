...
const SEO_REGISTRY = [
  // 1. ANA SAYFA (FLAGSHIP HOME HUB)
  {
    ...
    metaDescription: 'İzmir Buca Menderes Caddesinde 1999 yılından bu yana ekspertizli Rolex, Patek Philippe, Audemars Piguet saatler, 24K külçe altın ve pırlanta mücevherat. Canlı borsa kurları ve güvenli teslimat.',
  ...
  // 5. MÜCEVHERAT (JEWELLERY & GOLD HUB)
  {
    ...
    metaDescription: 'Belgin Kuyumculuk İzmir Buca mücevherat ve altın koleksiyonu. 24K külçe altın, 22 ayar bilezik, pırlanta tektaş ve özel tasarım mücevher modelleri.',
  ...
  // 8. REHBER: ÖZEL MATRAH & ALTIN YATIRIMI
  {
    ...
    metaDescription: '24K Külçe altın, 22 ayar bilezik ve sarrafiye alımında 3065 sayılı KDV Kanunu 23/f özel matrah uygulaması, canlı borsa fiyatlaması ve güvenli faturalama rehberi.',
  ...
  // 9. REHBER: LÜKS SAAT EKSPERTİZ & ORİJİNALLİK
  {
    ...
    publishedAt: '2026-02-01T10:00:00+03:00',
    modifiedAt: '2026-09-04T12:00:00+03:00',
    llmSubGraphRoute: '/llms/pages/rehber/luks-saat-ekspertiz-ve-orijinallik-rehberi.md',
  ...
  // 11. REHBER: PIRLANTA VE GEMOLOJİ DEĞERLEME
  {
    ...
    publishedAt: '2026-02-01T10:00:00+03:00',
    modifiedAt: '2026-09-04T12:00:00+03:00',
    llmSubGraphRoute: '/llms/pages/rehber/pirlanta-ve-gemoloji-degerleme-rehberi.md',
    informationGainElements: ['expertExperience', 'comparisonMatrix'],
    richResultTypes: ['Article', 'WebPage', 'BreadcrumbList'],
