          ...
          <div class="pdp-gold-wire-protocol">
            ...
            <div class="pdp-gold-wire-step pdp-gold-wire-step-bank">
              ...
              <div class="pdp-gold-iban-row">
                ...
                <button type="button" class="pdp-gold-iban-copy-btn" onclick="if(navigator.clipboard){navigator.clipboard.writeText('TR050020500009275715800001');if(typeof showToast==='function'){showToast('Kuveyt Türk IBAN kopyalandı.','success');}else{alert('Kuveyt Türk IBAN kopyalandı.');}}else{prompt('Kuveyt Türk IBAN:','TR050020500009275715800001');}" aria-label="IBAN Kopyala">
                  <span>📋</span> Kopyala
                </button>
              </div>
            </div>
