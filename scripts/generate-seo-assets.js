...
function buildRobots() {
  ...
  const blockedTrainingBot = (agent) => `User-agent: ${agent}\nDisallow: /\n`;
  write('robots.txt', [
    ...
    blockedTrainingBot('GPTBot'),
    blockedTrainingBot('ClaudeBot'),
    blockedTrainingBot('Google-Extended'),
