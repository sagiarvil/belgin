...
assert(eliteProducts.length >= 200, `Elit Kategori en az 200 Haute Horlogerie modeli içeriyor (mevcut: ${eliteProducts.length})`);
assert(eliteProducts.every(p => p.category === 'elit-saatler'), 'Tüm elit modeller elit-saatler kategorisiyle tutarlı');
